...
public class CustomAdapter_web extends CursorAdapter {
     ...
     */
    public CustomAdapter_web(Context context, Cursor c, boolean autoRequery) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        View v = mInflater.inflate(R.layout.listview_item_web, parent, false);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String title = cursor.getString(cursor.getColumnIndexOrThrow(ExamDbContract_web.ExamDbEntry.TITLE));
        ...
        String update = cursor.getString(cursor.getColumnIndexOrThrow(ExamDbContract_web.ExamDbEntry.UPDATED_AT));
